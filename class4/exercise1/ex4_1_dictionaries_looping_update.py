...
# Print the 'ip_addr' value from the 'net_device' dictionary
print()
...
# Append 'bgp_fields' dictionary to 'net_device' dictionary
net_device.update(bgp_fields)

# Print the key for each dictionary element
print('-' * 80)
...
# Print the key and value for each dictionary element
print('-' * 80)
