...
datafolder = pathlib.Path(r'C:\Users\wbell\Documents\Python\Kirk Byers Online\Lesson 3 - Conditionals and Loops')
#my_file = datafolder / "sh_arp.txt"

with open("sh_arp.txt") as f:
    show_arp = f.read()
